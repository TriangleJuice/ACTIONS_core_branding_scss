...
```
<link rel="stylesheet" href="https://cdn.antwerpen.be/core_branding_scss/4.3.5/main.min.css">
```

You can even import it directly in your (S)CSS:

```
@import url("https://cdn.antwerpen.be/core_branding_scss/4.3.5/main.min.css");
```
